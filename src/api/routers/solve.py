...
@router.get("/solve/health")
async def health_check():
    """Health check."""
    return build_health_payload("solve")
...
async def websocket_solve(websocket: WebSocket):
    ...
    try:
        ...
        # The main logger already writes to data/user/logs/thinkpilot_YYYYMMDD.log
        ...
        with interceptor:
            ...
            if session_id:
                ...
                solver_session_manager.add_message(
                    ...
                    output_dir=dir_name,
                    metadata={
                        "verification_passed": result_metadata.get("verification_passed"),
                        "verification_confidence": result_metadata.get("verification_confidence"),
                        "used_web_fallback": result_metadata.get("used_web_fallback"),
                        "grounding_strength": result_metadata.get("grounding_strength"),
                    },
                )
