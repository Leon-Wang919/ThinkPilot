...
This module provides a collection of various tools used in the ThinkPilot system, including code execution, knowledge retrieval, web search, paper search, and more.
...
├─┢ code_executor.py         # Code execution tool ?├─┢ query_item_tool.py       # Numbered item query tool ?├─┢ rag_tool.py              # RAG retrieval tool ?├─┢ web_search.py            # Web search tool
