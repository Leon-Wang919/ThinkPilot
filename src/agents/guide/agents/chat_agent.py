        ...
        grounding_block = "\n\n".join(
            ...
            for part in [
                ...
                (
                    ...
                    "Answer conservatively. If the KB grounding is limited, say so and avoid overclaiming."
                )
                if grounding_warning
                else (
                    "Answer from the KB grounding context first. Only add light generic explanations when the KB context"
                    " is incomplete, and keep them clearly consistent with the selected knowledge base."
                ),
            ]
            if part
        )
