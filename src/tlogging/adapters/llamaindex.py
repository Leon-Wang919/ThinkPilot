...
Forwards LlamaIndex logs to ThinkPilot's unified logging system.
"""
...
class LlamaIndexLogForwarder(logging.Handler):
    """
    Handler that forwards LlamaIndex logger messages to ThinkPilot logger.
    """
    ...
    def emit(self, record: logging.LogRecord):
        """
        Forward log record to ThinkPilot logger.
        """
        try:
...
def LlamaIndexLogContext(
    ...
    for llama_logger in llama_loggers:
        ...
        # Add forwarder
        forwarder = LlamaIndexLogForwarder(thinkpilot_logger)
