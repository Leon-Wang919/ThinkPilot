...
# Import standard library logging using absolute import
import importlib
import json
import sys
...
class Logger:
    ...
    def __init__(
        ...
        self.logger = logging.getLogger(f"thinkpilot.{name}")
        ...
        if file_output:
            ...
            log_file = log_dir_path / f"thinkpilot_{timestamp}.log"
