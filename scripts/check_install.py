#!/usr/bin/env python
"""
ThinkPilot Installation Checker
...
def check_backend_packages() -> tuple[bool, int, int]:
    ...
    packages = [
        ...
        # RAG
        ("lightrag-hku", "lightrag", "1.0.0", True),
        ("raganything", "raganything", "0.1.0", True),
        ("llama-index", "llama_index", "0.14.0", True),
        # Document parsing
...
def main():
    """Main function"""
    print("\n" + "=" * 60)
    print("🔍 ThinkPilot Installation Checker")
    print("=" * 60)
    ...
    if all_checks_passed:
        ...
        print_info("You can start ThinkPilot with: python scripts/start_web.py")
    else:
