...
Migrate existing knowledge bases into ThinkPilot's knowledge base system.
...
async def migrate_kb(
    ...
    """
    Migrate a knowledge base to ThinkPilot.
    ...
    print(f"  Knowledge base '{kb_name}' is now available in ThinkPilot.")
    print("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(
        description="Migrate knowledge bases into ThinkPilot",
