#!/bin/bash
# ThinkPilot One-Click Installation Script
#
...
echo ""
echo "============================================================"
echo "🚀 ThinkPilot One-Click Installation Script"
echo "============================================================"
...
if python -c "import lightrag" 2>/dev/null; then
    ...
    print_warning "  ?lightrag_hku not installed (optional)"
fi
...
if python -c "import raganything" 2>/dev/null; then
    ...
    print_warning "  ?raganything not installed (optional)"
fi
...
if python -c "import llama_index" 2>/dev/null; then
    ...
    print_warning "  ?llama_index not installed (optional)"
fi
