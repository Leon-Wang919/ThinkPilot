...
class AITutorStarter:
    ...
    def __init__(self):
        ...
        try:
            ...
            logger.error(str(e))
            logger.error("Please configure LLM settings in .env or ThinkPilot.env file")
            sys.exit(1)

        # Load knowledge base list
        self.available_kbs = self._load_available_kbs()

        logger.section("ThinkPilot Intelligent Teaching Assistant System")
    ...
    def show_main_menu(self) -> str:
        ...
        print(
            "2. � Deep Research (Research)     - Multi-round deep knowledge research"
        )
        print("3. 💡 Idea Generation (IdeaGen)      - Extract research ideas from notes")
        print("4. 🌐 Start Web Service (Web)       - Start frontend and backend services")
        print("5. ⚙️  System Settings (Settings)     - View/modify configuration")
        print("6. 🚪 Exit")
        logger.separator()
        ...
        while True:
            try:
                ...
                if choice == "1":
                    ...
                    print("\n" + "=" * 70)
                    print("👋 Thank you for using ThinkPilot Intelligent Teaching Assistant System!")
                    print("=" * 70)
                    break
